...
namespace OperationalPlanMS.Data
{
    ...
    public static class DbSeeder
    {
        ...
        public static async Task SeedAsync(AppDbContext db)
        {
            ...
            {
                new() { Id = 100, ParentId = null, TenantId = 1, Code = "HQ",    ArabicName = "القيادة العامة",          IsActive = true },
                new() { Id = 101, ParentId = 100,  TenantId = 1, Code = "OPS",   ArabicName = "قسم العمليات",            IsActive = true },
                new() { Id = 102, ParentId = 100,  TenantId = 1, Code = "IT",    ArabicName = "قسم تقنية المعلومات",     IsActive = true },
                new() { Id = 103, ParentId = 100,  TenantId = 1, Code = "HR",    ArabicName = "قسم الموارد البشرية",     IsActive = true },
                new() { Id = 104, ParentId = 100,  TenantId = 1, Code = "FIN",   ArabicName = "قسم الشؤون المالية",      IsActive = true },
                new() { Id = 105, ParentId = 100,  TenantId = 1, Code = "LOG",   ArabicName = "قسم الإمداد والتموين",    IsActive = true },
                new() { Id = 106, ParentId = 100,  TenantId = 1, Code = "TRN",   ArabicName = "قسم التدريب والتأهيل",    IsActive = true },
                new() { Id = 110, ParentId = 102,  TenantId = 1, Code = "DEV",   ArabicName = "شعبة التطوير البرمجي",    IsActive = true },
                new() { Id = 111, ParentId = 102,  TenantId = 1, Code = "NET",   ArabicName = "شعبة الشبكات والبنية التحتية", IsActive = true },
                new() { Id = 112, ParentId = 102,  TenantId = 1, Code = "SEC",   ArabicName = "شعبة الأمن السيبراني",    IsActive = true },
            };
            ...
            {
                new() { Id = 1,  ADUsername = "admin",       FullNameAr = "أحمد بن سعيد الريامي",      FullNameEn = "Ahmed Al Riyami",        Email = "ahmed@opms.om",     RoleId = 1, PasswordHash = passwordHash, ExternalUnitId = 100, EmployeeRank = "مدير أول",    EmployeePosition = "مدير النظام",       BranchName = "القيادة العامة",          IsActive = true, IsStepApprover = true },
                new() { Id = 2,  ADUsername = "executive1",  FullNameAr = "خالد بن محمد البلوشي",      FullNameEn = "Khalid Al Balushi",      Email = "khalid@opms.om",    RoleId = 2, PasswordHash = passwordHash, ExternalUnitId = 100, EmployeeRank = "مدير تنفيذي",    EmployeePosition = "المدير التنفيذي",   BranchName = "القيادة العامة",          IsActive = true, IsStepApprover = true },
                new() { Id = 3,  ADUsername = "supervisor1", FullNameAr = "سالم بن عبدالله الحارثي",   FullNameEn = "Salem Al Harthi",        Email = "salem@opms.om",     RoleId = 3, PasswordHash = passwordHash, ExternalUnitId = 101, EmployeeRank = "مدير قسم",    EmployeePosition = "مشرف العمليات",     BranchName = "قسم العمليات",            IsActive = true, IsStepApprover = true },
                new() { Id = 4,  ADUsername = "supervisor2", FullNameAr = "يوسف بن حمد الكندي",       FullNameEn = "Yousuf Al Kindi",        Email = "yousuf@opms.om",    RoleId = 3, PasswordHash = passwordHash, ExternalUnitId = 102, EmployeeRank = "مدير قسم",    EmployeePosition = "مشرف تقنية المعلومات", BranchName = "قسم تقنية المعلومات", IsActive = true, IsStepApprover = true },
                new() { Id = 5,  ADUsername = "pm1",         FullNameAr = "ناصر بن علي المعمري",       FullNameEn = "Nasser Al Mamari",       Email = "nasser@opms.om",    RoleId = 4, PasswordHash = passwordHash, ExternalUnitId = 101, EmployeeRank = "رئيس فريق",    EmployeePosition = "مدير مشروع",        BranchName = "قسم العمليات",            IsActive = true },
                new() { Id = 6,  ADUsername = "pm2",         FullNameAr = "محمد بن سيف الهنائي",       FullNameEn = "Mohammed Al Hinaai",     Email = "mohammed@opms.om",  RoleId = 4, PasswordHash = passwordHash, ExternalUnitId = 102, EmployeeRank = "رئيس فريق",    EmployeePosition = "مدير مشروع",        BranchName = "قسم تقنية المعلومات",     IsActive = true },
                new() { Id = 7,  ADUsername = "pm3",         FullNameAr = "فهد بن خميس الراشدي",       FullNameEn = "Fahad Al Rashdi",        Email = "fahad@opms.om",     RoleId = 4, PasswordHash = passwordHash, ExternalUnitId = 103, EmployeeRank = "رئيس فريق",    EmployeePosition = "مدير مشروع",        BranchName = "قسم الموارد البشرية",     IsActive = true },
                new() { Id = 8,  ADUsername = "step1",       FullNameAr = "حمود بن راشد السعدي",       FullNameEn = "Hamoud Al Saadi",        Email = "hamoud@opms.om",    RoleId = 7, PasswordHash = passwordHash, ExternalUnitId = 110, EmployeeRank = "أخصائي أول",    EmployeePosition = "مطور أنظمة",        BranchName = "شعبة التطوير البرمجي",    IsActive = true },
                new() { Id = 9,  ADUsername = "step2",       FullNameAr = "عبدالله بن سالم الشكيلي",   FullNameEn = "Abdullah Al Shkaili",    Email = "abdullah@opms.om",  RoleId = 7, PasswordHash = passwordHash, ExternalUnitId = 111, EmployeeRank = "أخصائي أول",    EmployeePosition = "مهندس شبكات",       BranchName = "شعبة الشبكات والبنية التحتية", IsActive = true },
                new() { Id = 10, ADUsername = "step3",       FullNameAr = "سعود بن هلال العامري",      FullNameEn = "Saud Al Amri",           Email = "saud@opms.om",      RoleId = 7, PasswordHash = passwordHash, ExternalUnitId = 112, EmployeeRank = "أخصائي", EmployeePosition = "محلل أمن سيبراني", BranchName = "شعبة الأمن السيبراني",    IsActive = true },
                new() { Id = 11, ADUsername = "step4",       FullNameAr = "مازن بن خلفان البوسعيدي",   FullNameEn = "Mazen Al Busaidi",       Email = "mazen@opms.om",     RoleId = 7, PasswordHash = passwordHash, ExternalUnitId = 106, EmployeeRank = "فني",   EmployeePosition = "مدرب",              BranchName = "قسم التدريب والتأهيل",    IsActive = true },
                new() { Id = 12, ADUsername = "step5",       FullNameAr = "هيثم بن ناصر الوهيبي",      FullNameEn = "Haitham Al Wahaibi",     Email = "haitham@opms.om",   RoleId = 7, PasswordHash = passwordHash, ExternalUnitId = 104, EmployeeRank = "فني",   EmployeePosition = "محاسب",             BranchName = "قسم الشؤون المالية",      IsActive = true },
            };
            ...
            {
                new() { ExternalUnitId = 101, ExternalUnitName = "قسم العمليات",        VisionAr = "التميز في تخطيط وتنفيذ العمليات",                     MissionAr = "ضمان جاهزية العمليات وتنفيذها وفق أعلى المعايير",                  CreatedById = 1 },
                new() { ExternalUnitId = 102, ExternalUnitName = "قسم تقنية المعلومات", VisionAr = "قيادة التحول الرقمي والابتكار التقني",                 MissionAr = "توفير بنية تقنية متطورة وحلول ذكية تدعم الجاهزية والتميز المؤسسي", CreatedById = 1 },
                new() { ExternalUnitId = 103, ExternalUnitName = "قسم الموارد البشرية", VisionAr = "بناء رأس مال بشري متميز ومؤهل",                       MissionAr = "استقطاب وتطوير الكفاءات البشرية وتحقيق بيئة عمل محفزة",            CreatedById = 1 },
                new() { ExternalUnitId = 104, ExternalUnitName = "قسم الشؤون المالية",  VisionAr = "التميز في الإدارة المالية والرقابة",                   MissionAr = "ضمان الكفاءة في إدارة الموارد المالية والشفافية في التقارير",       CreatedById = 1 },
            };
            ...
            {
                new() { Id = 1, Code = "SUB-01", NameAr = "ترقية أنظمة الاتصالات المشفرة",        MainObjectiveId = 1, ExternalUnitId = 101, ExternalUnitName = "قسم العمليات",        OrderIndex = 1, CreatedById = 1 },
                new() { Id = 2, Code = "SUB-02", NameAr = "تأهيل فرق الاستجابة الأولى",          MainObjectiveId = 2, ExternalUnitId = 101, ExternalUnitName = "قسم العمليات",        OrderIndex = 1, CreatedById = 1 },
                new() { Id = 3, Code = "SUB-03", NameAr = "توفير بنية سحابية خاصة",              MainObjectiveId = 3, ExternalUnitId = 102, ExternalUnitName = "قسم تقنية المعلومات", OrderIndex = 1, CreatedById = 1 },
                new() { Id = 4, Code = "SUB-04", NameAr = "إطلاق نظام OPMS بالكامل",             MainObjectiveId = 4, ExternalUnitId = 102, ExternalUnitName = "قسم تقنية المعلومات", OrderIndex = 1, CreatedById = 1 },
                new() { Id = 5, Code = "SUB-05", NameAr = "بناء فريق الأمن السيبراني",            MainObjectiveId = 5, ExternalUnitId = 112, ExternalUnitName = "شعبة الأمن السيبراني", OrderIndex = 1, CreatedById = 1 },
                new() { Id = 6, Code = "SUB-06", NameAr = "تنفيذ 4 دورات قيادية سنوياً",          MainObjectiveId = 6, ExternalUnitId = 106, ExternalUnitName = "قسم التدريب والتأهيل", OrderIndex = 1, CreatedById = 1 },
                new() { Id = 7, Code = "SUB-07", NameAr = "أتمتة تقييم الأداء",                    MainObjectiveId = 7, ExternalUnitId = 103, ExternalUnitName = "قسم الموارد البشرية", OrderIndex = 1, CreatedById = 1 },
                new() { Id = 8, Code = "SUB-08", NameAr = "تطبيق نظام ERP المالي",                MainObjectiveId = 8, ExternalUnitId = 104, ExternalUnitName = "قسم الشؤون المالية",  OrderIndex = 1, CreatedById = 1 },
            };
            ...
            {
                new() { ProjectId = 1, SupportingEntityId = 2, ExternalUnitId = 102, ExternalUnitName = "قسم تقنية المعلومات", RepresentativeName = "يوسف بن حمد الكندي", RepresentativeRank = "مدير قسم" },
                new() { ProjectId = 1, ExternalUnitId = 105, ExternalUnitName = "قسم الإمداد والتموين", RepresentativeName = "سعيد بن محمد الفارسي", RepresentativeRank = "رئيس فريق" },
                new() { ProjectId = 2, ExternalUnitId = 101, ExternalUnitName = "قسم العمليات", RepresentativeName = "سالم بن عبدالله الحارثي", RepresentativeRank = "مدير قسم" },
                new() { ProjectId = 2, SupportingEntityId = 2, ExternalUnitId = 112, ExternalUnitName = "شعبة الأمن السيبراني", RepresentativeName = "سعود بن هلال العامري", RepresentativeRank = "أخصائي" },
